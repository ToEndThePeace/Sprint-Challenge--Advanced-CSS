...
* [done] Create a fixed navigation and add some opacity to the background

* [done] Create a form that would allow someone to sign up for a Spacewalkers Magazine subscription